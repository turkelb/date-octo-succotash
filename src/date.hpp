...
public:
	...
	static constexpr int OveralDayCount[12] = { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334 }; 
	static constexpr int DaysInMonths[13] = { 0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
